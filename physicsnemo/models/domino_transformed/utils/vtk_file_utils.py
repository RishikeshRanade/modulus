...
if VTK_AVAILABLE:
    ...
    if PYVISTA_AVAILABLE:
        ...
        def _raise_pyvista_import_error():
            ...
            raise ImportError(
                "pyvista is not installed, can not be used from domino_transformed/utils/vtk_file_utils.py"
    ...
    def _raise_vtk_import_error():
        ...
        raise ImportError(
            "vtk is not installed, can not be used from domino_transformed/utils/vtk_file_utils.py"
