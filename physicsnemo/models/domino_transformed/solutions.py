...
def apply_parameter_encoding(
    ...
    global_params_values : torch.Tensor
        Global parameters (values), shape :math:`(B, N_{params}, 1)`.
    global_params_reference : torch.Tensor
        Global parameters (reference for normalization), shape :math:`(B, N_{params}, 1)`.
...
class SolutionCalculatorVolume(Module):
    ...
    See Also
    --------
    :class:`~physicsnemo.models.domino_transformed.mlps.AggregationModel` : Used for final prediction.
    ...
    def forward(
        ...
        encoding_node: Float[torch.Tensor, "batch num_vol pos_features"] | None,
...
class SolutionCalculatorSurface(Module):
    ...
    def forward(
        ...
        encoding_node: Float[torch.Tensor, "batch num_surf pos_features"] | None,
        global_embedding: Float[torch.Tensor, "batch num_surf global_dim"] | None,
