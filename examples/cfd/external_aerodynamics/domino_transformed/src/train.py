...
"""
Distributed training pipeline for DoMINO-Transformed (token-direct geometry
encoding + hierarchical fusion). Same structure as the Domino example: scaling
factors, DoMINO-Transformed model and datapipe, checkpointing, DDP/FSDP,
mixed precision, validation, and TensorBoard logging.
"""
...
from physicsnemo.datapipes.cae.domino_transformed_datapipe import (
    DoMINODataPipe,
    create_domino_dataset,
)
from physicsnemo.models.domino_transformed.model import DoMINO
from physicsnemo.models.domino_transformed.utils import create_directory
