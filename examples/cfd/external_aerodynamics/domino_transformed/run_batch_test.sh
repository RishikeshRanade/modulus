...
#SBATCH --nodes=1
#SBATCH --job-name=shift-wing-test
...
srun -A coreai_modulus_cae  \
     ...
     cd /lustre/users/snidhan/SHIFT-Benchmarks/shift-wing-benchmarking/
     source myenv/bin/activate
     export LD_LIBRARY_PATH=/lustre/users/snidhan/SHIFT-Benchmarks/shift-wing-benchmarking/myenv/lib/python3.12/site-packages/nvidia/cuda_nvrtc/lib:$LD_LIBRARY_PATH
     cd /lustre/users/snidhan/SHIFT-Benchmarks/shift-wing-benchmarking/examples/cfd/external_aerodynamics/domino/src/
     ${RUN_CMD}"
